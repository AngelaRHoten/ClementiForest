...
<param ve-image 
       ...
       title="Remnants of a Kampung, Clementi Forest 2023"
       attribution="Angela Ricasio Hoten"
       fit="contain">
...
The Clementi Forest has emerged as a thriving ecosystem, home to native and non-native species alike. However, in 2020 the Urban Redevelopment Authority released its Master Plan for the next 10 to 15 years in the Clementi Area. The Clementi Forest was slated for redevelopment, which would ultimately lead to the deforestation of this young forest like its neighboring forest, [the Dover Forest](https://www.juncture-digital.org/AngelaRHoten/DoverForest). An online petition was released to the public soon after this Master Plan was released, advocating for the protection of the Clementi Forest from urbanization. It was able to collect over [20 000 signatures](https://www.change.org/p/urban-redevelopment-authority-of-singapore-protect-clementi-forest-from-urbanisation) thanks to the work of individual advocates, nature groups, and neighbouring communities of the Clementi Forest, and successfully held off the destruction of the Clementi Forest for the next ten years. Some remain critically hopeful of the long-term conservation of the Clementi Forest given the continued authority held by the State and eagerness to develop the "abandoned land". However, it appears that the public attention and investment into the conservation of the Clementi Forest over the last two years since the petition has shifted the environmental and social considerations that government agencies are taking into account when they consider deforesting spaces for development. 
<param ve-image 
